...
import com.example.api.Books.BookAdapter;
import com.example.api.Books.BookPojo;
        ...
        searchBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (searchEdt.getText().toString().isEmpty()) {
                    searchEdt.setError("Please enter search Books?");
                    return;
                }
        ...
        JsonObjectRequest booksObjrequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    // for loop
                    for (int i = 0; i < ((JSONArray) itemsArray).length(); i++) {
                        ...
                        BookPojo bookPojo = new BookPojo(title, subtitle, authorsArrayList, publisher, publishedDate, description, pageCount, thumbnail, previewLink, infoLink, buyLink);
                        ...
                        BookAdapter adapter = new BookAdapter(bookPojoArrayList, MainActivity.this);
                    ...
                    Toast.makeText(MainActivity.this, "No Data Found" + jsonException, Toast.LENGTH_SHORT).show();
                }
            }
